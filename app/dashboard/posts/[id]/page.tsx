...
import { ArrowLeft, Edit, Eye, Clock, Calendar, Tag, Heart, MessageCircle, Share2 } from "lucide-react"
...
export default function PostViewPage() {
  ...
  const getStatusBadge = (status: string) => {
    const variants = {
      ...
      pending_review: { variant: "default" as const, label: "Pending Review", color: "bg-yellow-100 text-yellow-800" },
      approved: { variant: "default" as const, label: "Published", color: "bg-green-100 text-green-800" },
  ...
  const canEdit = () => {
    ...
    if (user.role === "writer" && post.author.id === user.doctor_id) return true
    return false
  }
